...
circleHeight=104
circleWidth=0
circleFontFace="./osu-fontgen-fonts/CaviarDreams_Bold.ttf"
...
scoreHeight=62
scoreWidth=0
scoreFontFace="./osu-fontgen-fonts/SourceCodePro-Regular.ttf"
...
comboHeight=80
comboWidth=0
comboFontFace="./osu-fontgen-fonts/SourceCodePro-Bold.ttf"
